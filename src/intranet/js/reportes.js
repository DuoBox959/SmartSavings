document.addEventListener("DOMContentLoaded", async function () {
    try {
      ...
      document.getElementById("totalSupermercados").textContent = data.totalSupermercados;
      document.getElementById("productosMasComparados").textContent = data.productoMasComparado;
      ...
      new Chart(document.getElementById("usuariosChart"), {
        ...
        data: {
          ...
          datasets: [{
            ...
            data: [data.usuariosActivos, data.totalUsuarios - data.usuariosActivos],
