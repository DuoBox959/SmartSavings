    ...
    try {
        ...
        productosCache.forEach(producto => {
            productosTable.row.add([
                ...
                producto.peso ? `${producto.peso} ${producto.unidadPeso || 'kg'}` : '0 kg', // Mostrar peso con unidad seleccionada
...
function mostrarFormularioAgregar() {
    ...
    document.getElementById('formularioProducto').scrollIntoView({ behavior: 'smooth' }); // Desplazamiento suave al formulario
}
