...
document.addEventListener("DOMContentLoaded", async () => {
  ...
  try {
    ...
    document.getElementById("add-supermercado-select")?.addEventListener("change", (event) => toggleNuevoCampo(event.target.id, "add-supermercado-nuevo", "selector-ubicacion-dinamico"));
    ...
    document.getElementById("edit-supermercado-select")?.addEventListener("change", (event) => toggleNuevoCampo(event.target.id, "edit-supermercado-nuevo")); // Suponiendo una configuración similar para el modal de edición por ahora
    document.getElementById("edit-marca-select")?.addEventListener("change", (event) => toggleNuevoCampo(event.target.id, "edit-marca-nuevo"));
